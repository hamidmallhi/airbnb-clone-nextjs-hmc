...
function Header({placeholder}) {
    ...
    const selectionRange = {
      ...
      function search() {
        ...
        // to push the location, start date, end date and no-of-guests variables in to url through the query parameters and in the search page we will grab those variables
        router.push({
          pathname: "/search",
          query: {
